  ...
  return (
    <footer className="bg-[#0b0b0b] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-[#1E79AD] text-2xl sm:text-3xl font-bold mb-4">
              {settings.site_name}
            </h2>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Контакты</h3>
            <div className="space-y-3 sm:space-y-4 text-white/80 text-sm">
              <p className="break-all">
                Email: <a href={`mailto:${settings.email}`} className="hover:text-[#1E79AD] transition break-all">
                  {settings.email}
                </a>
              </p>
              <p>
          ...
          <div className="flex flex-col items-center md:items-end mt-8 md:mt-0">
            <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Следите за нами</h3>
            <div className="flex gap-4 sm:gap-6">
              {settings.vk_url && (
                <a
                  ...
                  className="text-2xl sm:text-3xl hover:text-[#1E79AD] transition"
                  aria-label="VK"
                >
      ...
      <div className="border-t border-[#1E79AD]/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 text-center text-white/70 text-xs sm:text-sm">
